...
#[cfg(target_arch="arm")]
pub use target::Settings;
#[cfg(target_arch="arm")]
pub use target::PurpleDrop;

#[cfg(not(target_arch="arm"))]
pub use crate::mockpurpledrop::MockSettings as Settings;
#[cfg(not(target_arch="arm"))]
pub use crate::mockpurpledrop::MockPurpleDrop as PurpleDrop;
